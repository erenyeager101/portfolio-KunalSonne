...
function ExperienceCard({ item, index }) {
  ...
  return (
    ...
    >
      <span className="absolute -left-5 top-8 flex h-10 w-10 items-center justify-center rounded-full border-2 border-brand bg-white text-brand shadow-[0_18px_36px_-18px_rgba(37,99,235,0.55)] dark:bg-slate-950 z-10">
