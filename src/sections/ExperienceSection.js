      ...
      <div className="space-y-12">
        ...
        <div className="rounded-3xl border border-slate-200/70 bg-white/90 p-6 shadow-lg shadow-slate-200/40 dark:border-white/10 dark:bg-slate-950/80">
          <p className="text-sm text-slate-600 dark:text-slate-300">
            I thrive in cross-functional robotics and XR teams, translating field constraints into scalable software. Highlights include cutting telemetry latency by 25%, launching modular operator dashboards, and leading documentation habits that re-use across sprints.
          </p>
        </div>
